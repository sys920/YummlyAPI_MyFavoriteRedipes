  ...
  fetch(` http://api.yummly.com/v1/api/recipes?_app_id=75812ddd&_app_key=2640dca7cf225ad358cc12814a8cc376&allowedIngredient[]=chicken&allowedCuisine[]=cuisine^cuisine-american`)
    ...
    for ( let i = 0 ; i < json.ingredientLines.length ; i++ ) {
      ...
      str2 = `
       <div id="content">
          ...
          <li><img  src="${json.images.map(img => `${img.hostedLargeUrl}`)}" width ="100%"></li>
